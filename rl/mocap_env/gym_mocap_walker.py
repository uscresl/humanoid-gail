...
class RoboschoolMocapHumanoid(RoboschoolForwardWalkerMujocoXML):
    ...
    def __init__(self, model_xml=os.path.join(os.path.dirname(__file__), 'humanoid_mocap.xml')):
        RoboschoolForwardWalkerMujocoXML.__init__(self, model_xml, 'torso', action_dim=29, obs_dim=44, power=0.41)
    ...
    def robot_specific_reset(self):
        ...
        self.motor_names = [
            'upperneck_x', 'upperneck_y', 'upperneck_z', 'rfemur_x',
            'rfemur_y', 'rfemur_z', 'lfemur_x', 'lfemur_y', 'lfemur_z',
            'lowerback_x', 'lowerback_y', 'lowerback_z', 'rtoes_x',
            'ltibia_x', 'ltoes_x', 'thorax_x', 'thorax_y',
            'thorax_z', 'lowerneck_x', 'lowerneck_y', 'lowerneck_z', 'upperback_x', 'upperback_y', 'upperback_z',
            'rtibia_x', 'rfoot_x', 'rfoot_z', 'lfoot_x',
            'lfoot_z', ]
